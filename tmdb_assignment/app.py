...
def get_tv():
    ...
    for i in range(len(tv_response_obj['results'])):
        tv_result[tv_response_obj['results'][i]['id']] = {'name': tv_response_obj['results'][i]['name'], 'overview': tv_response_obj['results'][i]['overview'], 'poster_path': tv_response_obj['results'][i]['poster_path'],
                            'first_air_date': tv_response_obj['results'][i]['first_air_date'], 'vote_average': tv_response_obj['results'][i]['vote_average'], 'vote_count': tv_response_obj['results'][i]['vote_count'], 'genre_ids': tv_response_obj['results'][i]['genre_ids']} 
...
def get_multi_search():
    ...
    for i in range(len(multi_response_obj['results'])):
        if multi_response_obj['results'][i]["media_type"] == "tv":
            multi_search[multi_response_obj['results'][i]['id']] = {'media_type': "tv", 'name': multi_response_obj['results'][i]['name'], 'overview': multi_response_obj['results'][i]['overview'], 'poster_path': multi_response_obj['results'][i]['poster_path'],
                                'first_air_date': multi_response_obj['results'][i]['first_air_date'], 'vote_average': multi_response_obj['results'][i]['vote_average'], 'vote_count': multi_response_obj['results'][i]['vote_count'], 'genre_ids': multi_response_obj['results'][i]['genre_ids']} 
        elif multi_response_obj['results'][i]["media_type"] == "movie":
            multi_search[multi_response_obj['results'][i]['id']] = {'media_type': "movie",'title': multi_response_obj['results'][i]['title'], 'overview': multi_response_obj['results'][i]['overview'], 'poster_path': multi_response_obj['results'][i]['poster_path'],
...
def get_movie_details():
    ...
    movie_details_result['runtime'] = movie_details_obj['runtime']
...
def get_tv_show_details():
    ...
    tv_show_details_result['name'] = tv_details_obj['name']
    tv_show_details_result['episode_run_time'] = tv_details_obj['episode_run_time']
    tv_show_details_result['first_air_date'] = tv_details_obj['first_air_date']
